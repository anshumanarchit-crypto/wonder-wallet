                ...
                <div className="grid md:grid-cols-2 gap-10">
                    <Card className="bg-gradient-to-br from-white to-primary/5 border-primary/20 shadow-lg">
                        ...
                        <CardContent className="space-y-8">
                                ...
                                <div className="grid grid-cols-3 gap-3">
                                    {["train", "bus", "flight"].map((mode) => (
                                        <button
                                            ...
                                            className={`py-3 px-4 rounded-lg font-semibold transition-all border-2 ${transportMode === mode
                            ...
                            <div>
                                ...
                                <Input type="range" min="2000" max="200000" step="1000" value={totalBudget} onChange={(e) => setTotalBudget(Number(e.target.value))} className="w-full h-2" />
                            ...
                            <div>
                                ...
                                <Input type="range" min="1" max="21" value={tripDays} onChange={(e) => setTripDays(Number(e.target.value))} className="w-full h-2" />
                                <div className="text-xs text-muted-foreground mt-3 flex justify-between">
                                    <span>1 day</span>
                                    <span>21 days</span>
                                </div>
                    ...
                    <div className="space-y-4">
                        {budgetByCategory.map((category) => (
                            <Card key={category.id} className="bg-gradient-to-r from-white to-background hover:shadow-md transition-all border-primary/10">
                                <CardContent className="pt-6">
                                    ...
                                    <div className="w-full bg-muted rounded-full h-3 overflow-hidden">
                                        <div className="bg-gradient-to-r from-primary to-primary/60 h-3 rounded-full transition-all duration-300" style={{ width: `${category.percentage * 100}%` }} />
                                    </div>
                                </CardContent>
                            </Card>
                        ))}
